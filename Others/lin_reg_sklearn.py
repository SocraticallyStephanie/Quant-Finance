...
if __name__ == "__main__":
    ...
    # Open a scikit-learn linear regrssion model
    # and fit it to the training data

    lr_model = linear_model.LinearRegression()
    lr_model.fit(X_train, y_train)

    # Output the estimate parameters for the linear model
    ...
    # of the best fit from the ordinary least squares procedure
