...
if __name__ == "__main__":
    ...
    # Simulate the "linear" data using the above paramters
...
def glm_mcmc_inference(df, iterations = 5000):
    ...
    with basic_model:
        # Create a glm using the Patsy model syntax
        # We use a normal distribution for the likehood

        pm.glm.glm("y ~ x", df, family=pm.families.Normal())
